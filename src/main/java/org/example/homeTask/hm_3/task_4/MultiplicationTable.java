...
public class MultiplicationTable {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < array.length; i++) { // я думаю array[0].length можно смело заменить на array.length. Зачем тебе сдесь указывать индекс 0?
            for (int j = 0; j < array[i].length; j++) { // я думаю array[1].length можно смело заменить на array[i].length. Зачем тебе сдесь указывать индекс 1?
